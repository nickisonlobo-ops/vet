...
const allNavItems = [
  ...
  { to: '/clientes',      icon: 'identification', label: 'Tutores',     minPerfil: 'all' },
  { to: '/animais',       icon: 'paw',            label: 'Animais',     minPerfil: 'all' },
  { to: '/prontuarios',   icon: 'stethoscope',    label: 'Prontuários', minPerfil: 'all' },
