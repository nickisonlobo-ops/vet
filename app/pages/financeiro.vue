<template>
  <div class="min-h-full bg-gray-50/60 p-3 sm:p-8">
    ...
    <div class="relative rounded-3xl overflow-hidden mb-8 shadow-xl">
      <div class="absolute inset-0" :style="{ background: 'var(--color-primary-bg, linear-gradient(135deg, #059669, #0d9488))' }" />
    ...
    <div v-if="loading" class="flex flex-col items-center justify-center gap-4 py-32">
      <span class="inline-block w-12 h-12 border-4 border-emerald-500 border-t-transparent rounded-full animate-spin" />
            ...
            <div class="flex flex-col gap-2">
              <div v-for="(item, i) in donutData" :key="`dl${i}`" class="flex items-center justify-between gap-2">
                <div class="flex items-center gap-2 min-w-0">
                  <span class="w-2.5 h-2.5 rounded-full shrink-0" :style="{ background: DONUT_COLORS[i % DONUT_COLORS.length] }" />
        ...
        <div class="flex flex-col gap-4">
          ...
          <div class="bg-white rounded-3xl shadow-md border border-gray-100 p-5">
            ...
            <div v-else class="flex flex-col gap-2">
              ...
              >
                <span class="w-1.5 h-1.5 rounded-full bg-red-500 mt-1.5 shrink-0" />
